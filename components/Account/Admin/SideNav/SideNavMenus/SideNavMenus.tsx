...
import TopNavSerach from "../AdminTopNav/TopNavSerach/TopNavSearch";

interface Props {
  RoleFunc: () => void;
  DashboardFunc: () => void;
  AllItemsFunc: () => void;
  PermissionsFunc: () => void;
    ...
    >
      ...
      <Link href="/">
        <a className="sidebar-brand d-flex align-items-center justify-content-center">
          ...
          <div className="sidebar-brand-text mx-3">iBazar Admin Dashboard</div>
        </a>
      </Link>
      ...
      <li className="nav-item">
        ...
        >
          <div className="bg-white py-2 collapse-inner rounded">
            <h6 className="collapse-header">Permission Components:</h6>
            <a onClick={() => RoleFunc()} className="collapse-item">
              Manage Role
            </a>
            ...
            <a onClick={() => PermissionsFunc()} className="collapse-item">
              Manage Permissions
            </a>

            <a className="collapse-item">Others</a>
          </div>
        </div>
      </li>
