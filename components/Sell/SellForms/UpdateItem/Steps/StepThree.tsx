...
// TODO Send Images Old Images Link To Database To Delete manually Later From Cloudinary
    ...
    <Container>
      ...
      <div className="form-row">
        ...
        <div className="name">
          ...
          <strong>
            Please Note That If You Upload New Images Old Images Will Be
            Removed. You Will Have To upload All Images Again.
          </strong>
        </div>
        <div className="value">
